export const DB = {
  ...
  classes: {
    "2": { rate: 1.25, point: 400 }, // プレミアムクラス（高倍率）
    "3": { rate: 1.0,  point: 400 }, // 普通席（標準）
    "5": { rate: 0.75, point: 400 }, // 割引運賃（標準ポイント）
    "6": { rate: 0.75, point: 200 }, // 割引運賃（低ポイント）
    "7": { rate: 0.75, point: 0 },   // 特典航空券（ポイントなし）
    "8": { rate: 0.5,  point: 0 },   // 超割引（ポイントなし）

    B: { rate: 1.3, point: 400 },    // ファーストビジネス（高倍率）
    C: { rate: 1.2, point: 400 },    // ビジネス（標準）
    D: { rate: 1.0, point: 400 },    // ビジネス（低倍率）
    H: { rate: 0.8, point: 200 },    // スタンダード（一般的な運賃）
    I: { rate: 0.7, point: 100 },    // シンプル（低ポイント）
    J: { rate: 0.5, point: 0 }       // 特典航空券（ポイントなし）
  }
};
